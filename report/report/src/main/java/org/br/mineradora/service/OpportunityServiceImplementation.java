...
@ApplicationScoped
public class OpportunityServiceImplementation implements OpportunityService {

    private final QuotationRepository quotationRepository;
    private final OpportunityRepository opportunityRepository;

    @Inject
    public  OpportunityServiceImplementation(QuotationRepository quotationRepository, OpportunityRepository opportunityRepository)  {
    ...
    public void buildOpportunity(ProposalDTO proposal) {
        ...
        opportunity.setLastDollarQuotation(quotationEntities.stream().findFirst().get().getCurrencyPrice());
